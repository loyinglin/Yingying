//
//  SettingPayPasswordController.m
//  Yingying
//
...
@implementation SettingPayPasswordController
...
- (IBAction)onNext:(id)sender {
    if ([self checkPasswordOK]) {
        [self performSegueWithIdentifier:@"open_setting_new_pay_password_board" sender:self];
    }
